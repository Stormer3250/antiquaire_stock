...
const STEPS = {
  ...
  menus: [
    ['[data-vb-q]', 'Chercher',
      'Le nom d’une carte. Les accents et les majuscules n’ont pas d’importance.'],
    ['.vb-views', 'Table ou blocs',
      'Basculez entre la table (colonnes triables) et les cartes. Marge moyenne, prix moyen et écart de prix vivent dans les deux vues.'],
    ['.bloc', 'Une carte, ses recettes',
      'Cliquez la carte (ou la ligne, en vue table) pour ouvrir sa fiche : composition, tarifications multiples et export y vivent.'],
  ],
  cave: [
